...
public class DepartmentDataAccess {
	...
	public void insertUserToDepartment(Department department) {
	...
	public void updateUserDepartment(Department department,String previousDepartment) {
	...
	public void deleteUserFromDeprtment(Department department) {
